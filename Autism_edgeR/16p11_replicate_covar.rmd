...
#Import data
```{r}
counts <- read.csv("16p11_fpkm_avg_threshold.csv",header=TRUE)
m <- as.matrix(counts)

group <- as.factor(rep(c("Control","Case"),c(12,9)))
...
write.csv(de.com$table,"test_no_filter_16p11_table.csv")
```
