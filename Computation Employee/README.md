...
2. For windows: download putty or Ubuntu for windows(WSL) , if you are using a Mac/Linux you can just SSH to the server<br>
        - Putty link: https://www.chiark.greenend.org.uk/~sgtatham/putty/latest.html<br>
        - WSL: https://www.microsoft.com/en-us/p/ubuntu/9nblggh4msv6?activetab=pivot:overviewtab<br>
